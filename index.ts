      ...
      try {
        ...
        for await (const message of stream) {
          try {
            ...
            // Process the message
            await processCommand(client, conversation, message, content, address);
...
// Extract message processing to a separate function
async function processCommand(client, conversation, message, content, botAddress) {
  // Parse the command
